...
elmFranceLogo : Svg msg
elmFranceLogo =
    svg
        [ id "logo"
        , viewBox "0 -10 480 240"
        , class "logo"
        ]
        [ background
        , threeCentralShapes
...
leftCharacter =
    Svg.node "g"
        [ id "left-character", fill leftCharacterColor, strokeWidth ".423" ]
...
rightCharacter =
    Svg.node "g"
        [ id "right-character", fill rightCharacterColor ]
        ...
        , Svg.node "ellipse"
            ...
            []
        , Svg.node "path" [ d "M419.1 73.373c9.458-18.827 11.458-4.066 12.519-.795 1.68 5.215 4.729 5.966 4.729 5.966s-1.459 1.768-4.11-.442-4.23-4.457-4.761-6.578c-.53-2.121-4.758 4.889-4.758 4.889z", stroke leftCharacterColor ] []
        ]
